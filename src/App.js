  ...
  const [recipes, setRecipes] = useState([
    {
      ...
      instructions: [
        ...
        "Cook ground beef until brown and season.",
        "Drain water from spaghetti.",
        "Add marinara sauce, ground beef, and parmesan cheese to spaghetti.",
        "Mix well and serve.",
      ],
      prepTime: 10,
      cookTime: 20,
    ...
    },
    {
      ...
      instructions: [
        ...
        "Mix sugar, corn syrup, butter, vanilla, and salt in a bowl.",
    ...
    },
    {
      ...
      instructions: [
        ...
        "Cook bread in a skillet with butter.",
    ...
    },
    {
      ...
      instructions: [
        ...
        "Cook chicken in a skillet.",
        "Add butter, cream, and parmesan to skillet.",
      ...
      <main>
        ...
        {currentView === "home" && (
          <RecipeList
            ...
            onRecipeClick={(recipe) => handleViewChange("detail", recipe)}
          />
        )}
        ...
        {currentView === "edit" && updatedRecipe && (
          <RecipeForm
