...
describe('RecipeDetail Component', () => {
  ...
  test('renders recipe details', () => {
    ...
    render(<RecipeDetail recipe={recipe} onEdit={() => {}} onDelete={() => {}} />);
  ...
  test('calls onEdit handler when Edit button is clicked', () => {
    ...
    render(<RecipeDetail recipe={recipe} onEdit={onEdit} onDelete={() => {}} />);
  ...
  test('calls onDelete handler when Delete button is clicked', () => {
    ...
    render(<RecipeDetail recipe={recipe} onEdit={() => {}} onDelete={onDelete} />);
  ...
  test('does not render potentially harmful HTML in user input', () => {
    render(<RecipeDetail recipe={{ name: '<script>alert("XSS")</script>', category: 'Test' }} />);
